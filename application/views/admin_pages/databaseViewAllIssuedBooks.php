...
<div class="card">
    <div class="card-header">
        <h4 class="card-title"> Database View All Issued books </h4>
...
<!-- put all code here -->
 <link href="<?php echo base_url('assets/table_admin_view_assets/css/fresh-bootstrap-table.css');?>" rel="stylesheet" />
  ...
  <thead>
			  ...
			  <th data-field="stuname" data-sortable="true">Student</th>
              <th data-field="email" data-sortable="true">Email</th>
              <th data-field="course" data-sortable="true">Course</th>
              <th data-field="yr" data-sortable="true">Year</th>
			  <th data-field="semes" data-sortable="true">Sem</th>
   ...
   <!-- dont delete it, it will delete all search options and pagination --><th data-field="actions" data-visible="false"></th>
	   ...
	   foreach ($resultmega ->result() as $row)
	{
		...
		echo "<tr> ";
			...
			echo  "<td>".$row->studentCllgYear."</td>";
			echo  "<td>".$row->studentSemPart."</td>";
		echo "</tr>";
