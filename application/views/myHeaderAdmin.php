              ...
              <li >
                    ...
                    <div class="collapse" id="pagesExamples" >
                        <ul class="nav">
                          ...
                          <li >
                              <a href="<?php echo base_url('AdminCtrl/bookIssue');?>">
                                  <span class="sidebar-mini-icon">I</span>
                                  <span class="sidebar-normal"> Issue </span>
                              </a>
                          </li>
                        
                          <li>
                              <a href="<?php echo base_url('AdminCtrl/bookReturn');?>">
                                  <span class="sidebar-mini-icon">R</span>
                                  <span class="sidebar-normal"> Return </span>
                              </a>
                          </li>
                        
                          <li >
                              <a href="<?php echo base_url('AdminCtrl/databaseSearchBooks');?>">
                                  <span class="sidebar-mini-icon">S</span>
                          ...
                          <li >
                              <a href="<?php echo base_url('AdminCtrl/databaseStudentViewAllBooks');?>">
                                  <span class="sidebar-mini-icon">SB</span>
                                  <span class="sidebar-normal"> Student Books </span>
                              </a>
                          </li>
                        
                          <li >
                              <a href="<?php echo base_url('AdminCtrl/databaseViewAllIssuedBooks');?>">
                                  <span class="sidebar-mini-icon">AI</span>
                                  <span class="sidebar-normal"> All Issued Books </span>
                              </a>
                          </li>
              ...
              <li >
                    ...
                    <div class="collapse " id="componentsExamples">
                        <ul class="nav">
                          ...
                          <li >
                              <a href="<?php echo base_url('AdminCtrl/databaseAddNewBook');?>">
                          ...
                          <li >
                              <a href="<?php echo base_url('AdminCtrl/databaseDeleteBook');?>">
                                  <span class="sidebar-mini-icon">R</span>
                          ...
                          <li >
                              <a href="<?php echo base_url('AdminCtrl/databaseViewAllBooks');?>">
              ...
              <li >
                    ...
                    <div class="collapse " id="formsExamples">
                        <ul class="nav">
                          ...
                          <li >
                              <a href="<?php echo base_url('AdminCtrl/stuViewAllstudents');?>">
                                  <span class="sidebar-mini-icon">VA</span>
                                  <span class="sidebar-normal"> View All </span>
                              </a>
                          </li>
                          ...
                          <li >
                              <a href="<?php echo base_url('AdminCtrl/stuChangePw');?>">
						   ...
						   <li >
                              <a href="<?php echo base_url('AdminCtrl/stuDeleteStudent');?>">
                                  <span class="sidebar-mini-icon">DS</span>
                                  <span class="sidebar-normal"> Delete Student </span>
                              </a>
                          </li>
              ...
              <li >
                    ...
                    <div class="collapse " id="tablesExamples">
                        <ul class="nav">
                          ...
                          <li >
                              <a href="<?php echo base_url('AdminCtrl/admAddNew');?>">
                          ...
                          <li >
                              <a href="<?php echo base_url('AdminCtrl/admDeleteAdmin');?>">
                                  <span class="sidebar-mini-icon">DA</span>
                                  <span class="sidebar-normal"> Delete Admin </span>
                              </a>
                          </li>
                        
                          <li >
                              <a href="<?php echo base_url('AdminCtrl/admViewAlladmins');?>">
                                  <span class="sidebar-mini-icon">VA</span>
                                  <span class="sidebar-normal"> View All </span>
                              </a>
                          </li>
